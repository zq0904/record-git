...
(function (window, document) {
  ...
  Croppic.prototype = {
    ...
    createImgUploadControls: function () {
      ...
      if (that.options.customUploadButtonId === '') { that.imgUploadControl = that.outputDiv.find('.cropControlUpload'); } else {
    ...
    createCropControls: function () {
      ...
      html = '<div class="cropControls cropControlsCrop">' + cropControlZoomMuchIn + cropControlZoomIn + cropControlZoomMuchOut + cropControlZoomOut + cropControlRotateLeft + cropControlRotateRight + cropControlCrop + cropControlReset + '</div>';
