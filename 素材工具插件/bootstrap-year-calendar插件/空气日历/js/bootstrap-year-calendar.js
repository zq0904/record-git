	...
	Calendar.prototype = {
		...
		_renderBody: function() {
			...
			for(var m = 0; m < 12; m++) {
				...
				// 新增结构
				// 在这拿不到 数据源中新增加的样式 和 类名
				var str = '<div class="calendar_pollNum">\
										<table>\
											<tbody>\
												<tr>\
													<td class="singleSpan">&nbsp;&nbsp;&nbsp;优:<div class="singleSpan_text" style="background:rgb(67, 206, 23)">0</div></td>\
													<td class="singleSpan">&nbsp;&nbsp;&nbsp;良:<div class="singleSpan_text" style="background:rgb(239, 220, 49)">0</div></td>\
													<td class="singleSpan">轻度:<div class="singleSpan_text" style="background:rgb(255, 170, 0)">0</div></td>\
												</tr>\
												<tr>\
													<td class="singleSpan">中度:<div class="singleSpan_text" style="background:rgb(255, 64, 26)">0</div></td>\
													<td class="singleSpan">重度:<div class="singleSpan_text" style="background:rgb(210, 0, 64)">0</div></td>\
													<td class="singleSpan">严重:<div class="singleSpan_text" style="background:rgb(156, 10, 78)">0</div></td>\
												</tr>\
											</tbody>\
										</table>\
									</div>';
